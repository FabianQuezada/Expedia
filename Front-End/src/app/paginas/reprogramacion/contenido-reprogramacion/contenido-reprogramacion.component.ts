...
@Component({
  selector: 'app-contenido-reprogramacion',
  templateUrl: './contenido-reprogramacion.component.html',
  styleUrls: ['./contenido-reprogramacion.component.css']
})
export class ContenidoReprogramacionComponent implements OnInit {
